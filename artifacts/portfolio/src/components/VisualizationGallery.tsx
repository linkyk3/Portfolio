...
export const VisualizationGallery = ({ headerTitle, subnav, imageUrls: sourceImageUrls }: VisualizationGalleryProps) => {
  ...
  useEffect(() => {
    setIsLoading(true);
    setImageUrls(shuffleArray(sourceImageUrls));
    setAllImages([]);
      ...
      <div style={styles.pageShell}>
        ...
        <div style={styles.visPageContainer}>
          <header style={{ ...styles.visHeader, ...globalBlur }}>
            <div style={{ ...styles.visHeaderLeft, flexGrow: 1 }}>
              <Link
                href="/"
                style={f(500, '1.75rem', {
                  letterSpacing: '-0.02em',
          ...
          <h1 style={{...styles.pageTitle, ...globalBlur}}>
            {headerTitle}
          </h1>
