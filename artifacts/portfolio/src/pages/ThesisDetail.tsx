...
const thesisImg = (name: string) => r2Url(`selected-works/thesis/${name}`);
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${thesisImg('hero-background.webp')})`, minHeight: '50vh' }}
      >
      ...
      <article className="prose prose-invert max-w-none px-8 md:px-16 lg:px-24 py-12 text-foreground/90 prose-p:leading-relaxed prose-p:text-justify">
        ...
        <Image src={thesisImg('extract-2.webp')} alt="Extract 2" />
        ...
        <ImageGrid>
          <Image src={thesisImg('P1500091.webp')} alt="P1500091" />
          <Image src={thesisImg('P1500097.webp')} alt="P1500097" />
        </ImageGrid>

        <ImageGrid>
          <Image src={thesisImg('extract-1.webp')} alt="Extract 1" />
          <Image src={thesisImg('extract-3.webp')} alt="Extract 3" />
        </ImageGrid>
        ...
        <Image src={thesisImg('extract-4.webp')} alt="Extract 4" />
        ...
        <ImageGrid>
          <Image src={thesisImg('extract-5.webp')} alt="Extract 5" />
          <Image src={thesisImg('extract-6.webp')} alt="Extract 6" />
        </ImageGrid>
        ...
        <Image src={thesisImg('extract-7.webp')} alt="Extract 7" />

        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 my-8">
          <Image src={thesisImg('extract-9.webp')} alt="Extract 9" />
          <Image src={thesisImg('extract-10.webp')} alt="Extract 10" />
          <Image src={thesisImg('extract-11.webp')} alt="Extract 11" />
          <Image src={thesisImg('extract-12.webp')} alt="Extract 12" />
        </div>
        ...
        <Image src={thesisImg('extract-8.webp')} alt="Extract 8" />
        ...
        <Image src={thesisImg('extract-13.webp')} alt="Extract 13" />
        ...
        <Image src={thesisImg('extract-14.webp')} alt="Extract 14" />
        ...
        <ImageGrid>
          <Image src={thesisImg('extract-15.webp')} alt="Extract 15" />
          <Image src={thesisImg('extract-16.webp')} alt="Extract 16" />
        </ImageGrid>
        ...
        <Image src={thesisImg('extract-17.webp')} alt="Extract 17" />
        ...
        <Image src={thesisImg('extract-18.webp')} alt="Extract 18" />
        ...
        <Image src={thesisImg('extract-19.webp')} alt="Extract 19" />
        ...
        <Image src={thesisImg('extract-20.webp')} alt="Extract 20" />
